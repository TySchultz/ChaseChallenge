...
enum Styles {
    ...
    enum Text {
        ...
        //Chase Challenge
        static let borough  = TextStyle(font: .system(.bold), size: 14)
        static let name     = TextStyle(font: .system(.bold), size: 20)
        static let location = TextStyle(size: 14)
        static let phone    = TextStyle(font: .system(.bold), size: 13)
    ...
    enum Colors {
        ...
        enum Blue {
            static let background = Styles.Colors.Blue.medium.color.withAlphaComponent(0.5)
            static let medium = "007DDE"
